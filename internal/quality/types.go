...
// ---------------------------------------------------------------------------
// Complexity analysis abstraction (DIP: quality does not import daemon/complexity)
// ---------------------------------------------------------------------------

// ComplexityLevel represents a complexity classification.
type ComplexityLevel string

const (
	// ComplexityLevelSimple indicates a task with minimal structural complexity.
	ComplexityLevelSimple ComplexityLevel = "simple"
	// ComplexityLevelStandard indicates a task with typical structural complexity.
	ComplexityLevelStandard ComplexityLevel = "standard"
	// ComplexityLevelComplex indicates a task requiring deeper decomposition.
	ComplexityLevelComplex ComplexityLevel = "complex"
	// ComplexityLevelCritical indicates a task at the maximum complexity threshold.
	ComplexityLevelCritical ComplexityLevel = "critical"
)

// ComplexityInput holds the structural indicators used for complexity estimation.
...
// ComplexityResult is the result of complexity estimation.
type ComplexityResult struct {
	Level ComplexityLevel
}

// ComplexityAnalyzer abstracts complexity estimation.
type ComplexityAnalyzer interface {
	Estimate(input ComplexityInput) ComplexityResult
}

// ---------------------------------------------------------------------------
// Feature gate abstraction (DIP: quality does not import daemon/featuregate)
// ---------------------------------------------------------------------------

// FeatureProfileLevel represents a feature profile level.
type FeatureProfileLevel string

const (
	// ProfileLevelSimple is the lowest complexity profile level.
	ProfileLevelSimple FeatureProfileLevel = "simple"
	// ProfileLevelStandard is the default complexity profile level.
	ProfileLevelStandard FeatureProfileLevel = "standard"
	// ProfileLevelComplex is used for multi-step or high-risk tasks.
	ProfileLevelComplex FeatureProfileLevel = "complex"
	// ProfileLevelCritical is used for the highest-risk tasks.
	ProfileLevelCritical FeatureProfileLevel = "critical"
)

// FeatureProfile holds the feature toggle set for a complexity level.
type FeatureProfile struct {
	Level           FeatureProfileLevel
	EnabledFeatures map[string]bool
}

// FeatureGateEvaluator abstracts feature gate evaluation.
type FeatureGateEvaluator interface {
	Evaluate(level FeatureProfileLevel) FeatureProfile
}
