...
func TestEngine_Evaluate_SimpleFieldValidation(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name: "with empty string purpose - should pass (key exists)",
			context: map[string]interface{}{
				"task": map[string]interface{}{
					"purpose": "",
				},
		...
		{
			name: "with nil purpose - should pass (key exists)",
			context: map[string]interface{}{
				"task": map[string]interface{}{
					"purpose": nil,
				},
...
func TestEngine_Evaluate_OpNotExists(t *testing.T) {
	engine := NewEngine()
	...
	testCases := []struct {
		...
		{
			name: "key with empty string - should fail (key exists)",
			context: map[string]interface{}{
				"task": map[string]interface{}{
					"deleted": "",
				},
		...
		{
			name: "key with nil - should fail (key exists)",
			context: map[string]interface{}{
				"task": map[string]interface{}{
					"deleted": nil,
				},
		...
		{
			name: "key with value - should fail",
			context: map[string]interface{}{
				"task": map[string]interface{}{
					"deleted": true,
				},
